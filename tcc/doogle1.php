...
<body class="cor">
    ...
    <head>
    <div>
            <h1 class="relac2">Você está a um passo da felicidade!</h1>
     </div>
     <div>
     ...
     <table>
         <th>
            ...
            <div >
                <td>
                    <img class="fotos" src="img/felipe.jpg"/>
                </td>
                <td>
                    <img class="fotos" src="img/danilo.jpg"/>
                </td>
            </div>
         </th>
        </table>
        <div>
            <p class="relac3">Temos animais cadastrados proximo a você !</p>
        </div>
        <div>
            <p class="relac4">Qual é o seu amiguinho dos sonhos?</p>
        </div>
        <div class="menu2">
            <li class="btn btn-outline-light btn-sm btn-custom"><a href="#">Quero ajudar</a></li>
            <li class="btn btn-outline-light"><a href="#">Quero adotar</a></li>
        </div>
        <div>
            <b class="forum2">mostre me todos!</b>
        </div>
    </center>
    </head>
</body>
